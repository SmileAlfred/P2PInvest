...
import com.example.p2pinvest.util.pay.SignUtils;
import com.example.p2pinvest.util.pay.PayKeys;
import com.example.p2pinvest.util.pay.PayResult;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_title_back:
                this.removeCurrentActivity(ChongZhiActivity.this);
                break;
            case R.id.btn_chongzhi:
                ...
                Runnable payRunnable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.i("TAG", "run: alipay == null ? " + (alipay== null) + " + payInfo = " + payInfo);
                        // 调用支付接口，获取支付结果
