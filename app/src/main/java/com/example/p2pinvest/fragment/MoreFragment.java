...
import com.example.p2pinvest.activity.UserRegistActivity;
...
public class MoreFragment extends BaseFragment {
    ...
    protected void findViews(View view) {
        ...
        tvTitle = view.findViewById(R.id.tv_title);
        ivTitleSetting = view.findViewById(R.id.iv_title_setting);
        tvMoreRegist = view.findViewById(R.id.tv_more_regist);
        toggleMore = view.findViewById(R.id.toggle_more);
        tvMoreReset = view.findViewById(R.id.tv_more_reset);
        rlMoreContact = view.findViewById(R.id.rl_more_contact);
        tvMoreFankui = view.findViewById(R.id.tv_more_fankui);
        tvMoreShare = view.findViewById(R.id.tv_more_share);
        tvMoreAbout = view.findViewById(R.id.tv_more_about);
        tvMorePhone = view.findViewById(R.id.tv_more_phone);
